        ...
        if (this.state.reminderDialog) {
			return (
					<div>
						...
						>
							Summary : <TextField hintText="Enter the summary" onChange={this.handleChangeSummary}/><br/>
							Location : <TextField hintText="Enter the location" onChange={this.handleChangeLocation}/><br/>
							Start Time : <Datetime hintText="Date Picker" onChange={this.handleChangeStartTime}/><br/>
							Duration : <TextField hintText="Duration" onChange={this.handleChangeDuration}/>
						</Dialog>
					</div>
			);
		}
