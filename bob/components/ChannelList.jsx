        ...
        let lists=[];    
          for(let i=0;i<arr.name.length;i++)
          {
            if(arr.name[i] == this.props.userName){
              lists.push(<ListItem key={i} primaryText={arr.name[i]} secondaryText={arr.status[i]} rightIcon ={<IconMenu
                iconButtonElement={<IconButton style={{marginTop:-10}} ><MoreVertIcon /></IconButton>}
